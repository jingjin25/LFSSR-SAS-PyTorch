...
- PyTorch 1.0
### Dataset
We provide MATLAB code for preparing the training and testing data. Please first download corresponding light field datasets, and put them into the `LFData` folder.
...
- new models were trained for light fields with the angular resolution of 7x7, while the original ones were trained for 9x9 light fields. 
